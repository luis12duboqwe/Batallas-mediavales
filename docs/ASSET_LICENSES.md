...
| `src/assets/intro/castle-silhouette.svg` | SVG | Activo preexistente en el repositorio; procedencia externa no documentada | Pendiente de confirmación o reemplazo | Introducción / autenticación | Provisional |
...
- Si no puede demostrarse procedencia/licencia de un activo preexistente, debe reemplazarse antes de marcar BM-0080 como terminado.
