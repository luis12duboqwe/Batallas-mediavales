...
DEFAULT_QUESTS: List[Dict[str, Any]] = [
    {
        "quest_id": "tutorial_building",
        "title": "Construye tu primer edificio",
        "description": "Completa una mejora para empezar tu reino.",
        "requirements": {"type": "building_finished", "building_type": "town_hall", "level": 1},
        "reward": {"resources": {"wood": 300, "clay": 250, "iron": 200}},
        "is_tutorial": True,
    },
    {
        "quest_id": "tutorial_troops",
        "title": "Entrena tropas",
        "description": "Entrena 10 unidades para defender tu ciudad.",
