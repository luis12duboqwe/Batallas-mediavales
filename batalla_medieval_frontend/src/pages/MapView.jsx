...
const MapView = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[300px,1fr] gap-6 h-[calc(100vh-120px)]">
      <div className="card p-4 space-y-4 h-full">
        ...
        <div className="space-y-2">
          <label className="text-sm text-gray-400">Ir a coordenada</label>
        ...
        <div className="space-y-1 text-sm text-gray-400">
          ...
          {loadingMap && <p className="text-xs text-gray-500">Actualizando mapa...</p>}
        </div>
      </div>
